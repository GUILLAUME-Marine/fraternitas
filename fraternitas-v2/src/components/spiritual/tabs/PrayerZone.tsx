"use client";
// ─── tabs/PrayerZone.tsx v4 ───────────────────────────────────────────────────
// Zone de prière desktop uniquement.
// Mobile → MobilePrayerLayout (pavé Prière).
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <div className="prayer-body">
      {people.length > 0 && (
        <div style={{ background:"#FFF8EA", border:"1px solid var(--gold-b)", borderRadius:14, padding:"12px 15px", marginBottom:14 }}>
          <strong style={{ display:"block", fontSize:10, fontWeight:700, letterSpacing:".11em", textTransform:"uppercase", color:"var(--gold)", marginBottom:4 }}>
            À porter aujourd&apos;hui
          </strong>
          <p style={{ fontFamily:"var(--serif)", fontStyle:"italic", fontSize:16, color:"var(--ink80)", lineHeight:1.45 }}>
            {people.join(" · ")}
          </p>
        </div>
      )}
          ...
          <div className="prayer-head">
            {activeTab==="jour" ? (
              ...
              <>
                ...
                <h2 style={{ fontFamily:"var(--serif)", fontSize:28, fontWeight:300, color:"var(--ink)", letterSpacing:"-.03em", marginBottom:5, lineHeight:1.1 }}>
