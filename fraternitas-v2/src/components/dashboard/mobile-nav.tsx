...
const items = [
  ...
  { href: "/dashboard/spiritual",    label: "Spirituel",  exact: false, icon: "cross",    special: true },
    ...
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50"
      ...
      {items.map((item) => {
        ...
        return (
          ...
          >
            {/* Indicateur actif — trait en haut */}
            {isActive && (
              <div style={{
                position: "absolute", top: 0, left: "50%", transform: "translateX(-50%)",
                width: "26px", height: "2px", borderRadius: "0 0 2px 2px",
