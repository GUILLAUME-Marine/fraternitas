...
const links = [
  ...
  { section: "Personnel" },
  { href: "/dashboard/spiritual", icon: "📖", label: "Contenu spirituel" },
          ...
          <Link key={link.href} href={link.href!}
            className={cn(
              ...
              isActive
                ...
                : "text-[rgba(17,16,9,0.65)] hover:bg-[#F7F3EC] hover:text-[#111009]"
            )}>
            <span className={cn(
              "w-8 h-8 rounded-lg flex items-center justify-center text-base flex-shrink-0 transition-colors",
