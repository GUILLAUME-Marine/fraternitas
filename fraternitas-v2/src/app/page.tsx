  ...
  return (
    <>
      ...
      <header className="lp-nav-shell" id="lpNavShell" aria-label="Navigation principale">
        <div className="lp-wrap lp-nav">
          ...
          <div className="lp-nav-actions">
            ...
            <Link className="lp-btn lp-btn-dark" href="/auth/register">
              Rejoindre la bêta →
            </Link>
          </div>

          {/* Hamburger + menu overlay — Client Component */}
          <NavMobile />
        </div>
      </header>
      ...
      <main id="contenu">
        ...
        <section id="top" className="lp-hero" aria-labelledby="hero-title">
          <div className="lp-wrap lp-hero-inner">
            ...
            <p className="lp-hero-lead">
              ...
              messe, des cercles locaux et un lieu calme pour prier entre deux
              rendez-vous.
            </p>
            <div className="lp-hero-actions">
              <Link className="lp-btn lp-btn-gold" href="/auth/register">
                Rejoindre les premiers membres →
              </Link>
              <a className="lp-btn lp-btn-ghost-dark" href="#rencontre">
                Voir comment ça marche
              </a>
            </div>
            <p className="lp-micro">
              ✦ Bêta ouverte · Cercles ouverts ville par ville
            </p>
          </div>
        </section>
        ...
        >
          <div className="lp-section-head lp-reveal">
            <div>
              ...
              <h2 id="community-title" className="lp-h2">
                ...
                <span className="lp-gold">Une communauté réelle.</span>
              </h2>
            </div>
            <p className="lp-copy">
          ...
          <div className="lp-grid-3">
            {features.map((f, i) => (
              <article
                key={f.title}
                className={`lp-card lp-feature lp-reveal lp-delay-${i + 1}`}
              >
                <h3>{f.title}</h3>
                <p>{f.body}</p>
              </article>
        ...
        <section
          id="rencontre"
          className="lp-section lp-story-section"
          ...
          <div className="lp-wrap lp-story-grid">
            <div className="lp-reveal">
              ...
              <h2 id="meeting-title" className="lp-story-lines">
                ...
                <span>
                  vous{" "}
                  <em style={{ color: "var(--lp-gold)", fontStyle: "italic" }}>
                    attend.
                  </em>
                </span>
              </h2>
            ...
            <aside
              className="lp-encounter-card lp-reveal lp-delay-1"
              aria-label="Aperçu d'une rencontre locale"
            >
              ...
              <div className="lp-enc-body">
                <div className="lp-enc-meta">
                  <div className="lp-enc-meta-item">
                    <span>Lieu</span>
        ...
        >
          <div className="lp-rosary-section lp-reveal">
            <div>
              <span className="lp-kicker">Espace prière</span>
              <h2
                id="prayer-title"
                className="lp-h2"
                style={{
              ...
              >
                ...
                <span className="lp-gold">revenir à Dieu.</span>
              </h2>
              <p className="lp-copy" style={{ marginTop: "16px" }}>
            ...
            <div className="lp-demo-card" aria-label="Aperçu de l'espace prière">
              ...
              <div className="lp-prayer-mode">
                <article className="lp-mode-card">
                  <b>Chapelet</b>
        ...
        <section className="lp-forvous-section" aria-labelledby="forvous-title">
          <div className="lp-wrap">
            <div className="lp-forvous-head lp-reveal">
              <span className="lp-kicker lp-kicker-light">
                Faites-vous partie des nôtres ?
              </span>
              <h2 id="forvous-title" className="lp-h2 lp-h2-light">
                Fraternitas est fait pour vous{" "}
                <span className="lp-gold">si…</span>
              </h2>
            </div>
            <div className="lp-forvous-grid">
              {forvousItems.map((item, i) => (
                <div
                  key={item.title}
                  className={`lp-forvous-item lp-reveal lp-delay-${(i % 2) + 1}`}
                >
                  <div className="lp-forvous-check" aria-hidden="true">
                    ✓
                  </div>
                  <div>
                    <h3>{item.title}</h3>
        ...
        >
          <div className="lp-section-head lp-reveal">
            <div>
              ...
              <h2 id="trust-title" className="lp-h2">
                ...
                <span className="lp-gold">sûr.</span>
              </h2>
            </div>
            <p className="lp-copy">
          ...
          <div className="lp-trust-grid">
            {trustItems.map((item, i) => (
              <article
                key={item.title}
                className={`lp-trust lp-reveal lp-delay-${(i % 2) + 1}`}
              >
                <b>{item.title}</b>
                <p>{item.body}</p>
              </article>
        ...
        >
          <div className="lp-reveal">
            ...
            <h2 id="steps-title" className="lp-h2">
              Simple par principe.{" "}
              <span className="lp-gold">Profond par nature.</span>
            </h2>
          </div>
          <div className="lp-steps">
            {steps.map((step, i) => (
              <div
                key={step.num}
                className={`lp-step lp-reveal lp-delay-${i + 1}`}
              >
          ...
          <div className="lp-wrap">
            ...
            <div className="lp-faq-list">
              {faqItems.map((item, i) => (
                <details
                  key={item.q}
                  className={`lp-reveal${i > 0 ? ` lp-delay-${Math.min(i, 3)}` : ""}`}
                >
        ...
        >
          <div className="lp-wrap lp-reveal">
            ...
            <h2 id="final-title" className="lp-h2 lp-h2-light">
            ...
            <div className="lp-hero-actions lp-hero-actions-center">
              ...
              <Link className="lp-btn lp-btn-ghost-dark" href="/auth/login">
                Se connecter
              </Link>
            </div>
            <p className="lp-micro">
...
const features = [
  {
    ...
    body: "Des groupes de proximité dans votre ville. Petits, humains, enracinés dans la vie locale.",
  },
  {
    title: "Rencontres réelles",
    body: "Messe ensemble, café, dîner, service, retraite. L'application facilite. La vie se passe dehors.",
  },
  {
    title: "Prière partagée",
    body: "Intentions, prière du jour, chapelet interactif. La communauté ne remplace pas la prière : elle la soutient.",
  },
];
...
const forvousItems = [
  {
    ...
    body: "Vous avez peut-être déjà des amis dans la foi, mais vous souhaitez rencontrer de nouvelles personnes et élargir votre communauté.",
  },
  {
  ...
  },
  {
    ...
    body: "Vous aimez votre paroisse, mais vous aimeriez partager votre foi avec des personnes dans la même saison de vie.",
  },
  {
...
/* ─────────────────────────────────────────────────────────────
   STYLES — injectés dans <head> via Next.js
   Préfixe "lp-" sur toutes les classes pour éviter les
   conflits avec les styles du dashboard (globals.css).
───────────────────────────────────────────────────────────── */
...
/* ── RESET SCOPE ──────────────────────────────────── */
.lp-nav-shell *, .lp-hero *, .lp-section *,
.lp-story-section *, .lp-forvous-section *,
.lp-mission *, .lp-faq-section *, .lp-final-cta *,
.lp-footer * {
  box-sizing: border-box;
}

/* ── BODY OVERRIDES (landing uniquement) ──────────── */
body:has(.lp-hero) {
  background:
    radial-gradient(circle at 50% 0%, rgba(201,154,53,.10), transparent 36rem),
    linear-gradient(180deg, #f8f3eb 0%, var(--lp-cream) 42%, #efe6d8 100%);
  overflow-x: hidden;
}
...
.lp-nav-links a { text-decoration: none; transition: color .15s; color: rgba(17,16,11,.55); }
...
.lp-btn {
  ...
  border: 1.5px solid transparent; padding: 0 28px;
  font-weight: 800; font-family: var(--lp-sans); font-size: 15px; letter-spacing: -.01em;
  cursor: pointer; white-space: nowrap; text-decoration: none;
  transition: transform .18s var(--lp-ease), box-shadow .18s var(--lp-ease), opacity .18s;
  -webkit-tap-highlight-color: transparent;
}
.lp-btn:hover { transform: translateY(-2px); }
.lp-btn:active { transform: translateY(0); opacity: .88; }
.lp-btn-dark { background: var(--lp-night); color: #fff8ec; box-shadow: 0 14px 36px rgba(20,18,12,.22); }
...
.lp-kicker-light::before { background: var(--lp-gold) !important; }
...
.lp-hero {
  ...
  color: #fff8ec;
  background: radial-gradient(circle at 14% 16%, rgba(201,154,53,.16), transparent 22rem), radial-gradient(circle at 84% 10%, rgba(255,248,236,.07), transparent 22rem), radial-gradient(circle at 50% 115%, rgba(201,154,53,.14), transparent 30rem), linear-gradient(180deg, #14120c 0%, #0d0c08 100%);
  padding: 64px 0;
  padding-left: env(safe-area-inset-left);
  padding-right: env(safe-area-inset-right);
  font-family: var(--lp-sans);
...
.lp-hero::before {
  ...
  background-image: linear-gradient(rgba(255,248,236,.032) 1px, transparent 1px), linear-gradient(90deg, rgba(255,248,236,.022) 1px, transparent 1px);
...
.lp-feature h3 { font-family: var(--lp-serif); font-size: 32px; line-height: 1; letter-spacing: -.04em; margin: 0 0 10px; color: var(--lp-ink); }
...
.lp-rosary-section .lp-copy { color: rgba(255,248,236,.66); }
.lp-rosary-section .lp-kicker { color: #d7b361; }
.lp-rosary-section .lp-kicker::before { background: var(--lp-gold); }
.lp-demo-card { border: 1px solid rgba(255,248,236,.09); border-radius: 26px; background: rgba(255,255,255,.042); padding: 20px; }
.lp-prayer-status { display: flex; align-items: flex-start; justify-content: space-between; gap: 14px; padding: 13px 15px; border-radius: 16px; background: rgba(255,248,236,.065); border: 1px solid rgba(255,248,236,.08); }
.lp-prayer-status strong { display: block; font-family: var(--lp-serif); font-size: 20px; line-height: 1; letter-spacing: -.03em; color: #fff8ec; margin-bottom: 4px; }
.lp-prayer-status span { color: rgba(255,248,236,.5); font-size: 12.5px; line-height: 1.38; }
...
.lp-prayer-mode { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-top: 12px; }
.lp-mode-card { min-height: 100px; padding: 16px; border-radius: 20px; border: 1px solid rgba(255,248,236,.08); background: rgba(255,255,255,.038); }
.lp-mode-card b { display: block; font-family: var(--lp-serif); font-size: 24px; line-height: 1; letter-spacing: -.04em; margin-bottom: 7px; color: #fff8ec; }
.lp-mode-card p { margin: 0; color: rgba(255,248,236,.55); font-size: 13px; line-height: 1.45; }
.lp-rosary-wrap { display: flex; justify-content: center; align-items: center; position: relative; padding: 24px 0 20px; }
.lp-rosary-ring { position: relative; width: 110px; height: 110px; border: 1px solid rgba(255,248,236,.15); border-radius: 999px; }
.lp-bead { --a: 0deg; position: absolute; left: 50%; top: 50%; width: 8px; height: 8px; margin: -4px; border-radius: 999px; background: rgba(255,248,236,.3); transform: rotate(var(--a)) translateX(55px); }
.lp-bead.done { background: rgba(201,154,53,.7); }
.lp-bead.current { background: var(--lp-gold); box-shadow: 0 0 0 7px rgba(201,154,53,.16); }
.lp-rosary-cross { position: absolute; left: 50%; top: calc(50% + 74px); width: 16px; height: 26px; transform: translateX(-50%); color: var(--lp-gold); }
...
.lp-rosary-cross::before { width: 2.5px; height: 30px; }
.lp-rosary-cross::after { width: 18px; height: 2.5px; top: 42%; }
.lp-progress { height: 8px; border-radius: 999px; background: rgba(255,255,255,.10); overflow: hidden; margin-top: 14px; }
.lp-progress span { display: block; width: 62%; height: 100%; background: var(--lp-gold); border-radius: 999px; }

/* ── POUR VOUS SI ─────────────────────────────────── */
.lp-forvous-section { background: var(--lp-night); border-top: 1px solid rgba(255,248,236,.055); border-bottom: 1px solid rgba(255,248,236,.055); padding: 80px 0; color: #fff8ec; font-family: var(--lp-sans); }
.lp-forvous-head { text-align: center; margin-bottom: 48px; }
.lp-forvous-head .lp-h2 { max-width: 640px; margin: 12px auto 0; }
.lp-forvous-grid { display: grid; grid-template-columns: repeat(2,1fr); gap: 12px; max-width: 880px; margin: 0 auto; }
.lp-forvous-item { display: flex; align-items: flex-start; gap: 14px; padding: 22px 24px; border-radius: 20px; border: 1px solid rgba(255,248,236,.07); background: rgba(255,255,255,.032); transition: background .2s var(--lp-ease), border-color .2s var(--lp-ease); }
.lp-forvous-item:hover { background: rgba(255,255,255,.052); border-color: rgba(201,154,53,.2); }
.lp-forvous-check { flex-shrink: 0; width: 24px; height: 24px; border-radius: 999px; margin-top: 2px; border: 1px solid rgba(201,154,53,.36); background: rgba(201,154,53,.09); display: grid; place-items: center; color: var(--lp-gold); font-size: 12px; }
.lp-forvous-item h3 { margin: 0 0 4px; font-size: 16px; font-weight: 800; letter-spacing: -.012em; color: #fff8ec; }
.lp-forvous-item p { margin: 0; font-size: 13.5px; line-height: 1.6; color: rgba(255,248,236,.50); }
...
.lp-faq-list summary { list-style: none; display: flex; align-items: center; justify-content: space-between; gap: 20px; padding: 20px 24px; font-weight: 800; font-size: 15px; cursor: pointer; min-height: 56px; -webkit-tap-highlight-color: transparent; color: var(--lp-ink); }
...
.lp-faq-list details p { margin: 0; padding: 0 24px 20px; color: var(--lp-ink-soft); line-height: 1.7; font-size: 15px; }

/* ── FINAL CTA ────────────────────────────────────── */
.lp-final-cta { background: radial-gradient(circle at 50% 0%, rgba(201,154,53,.10), transparent 22rem), linear-gradient(145deg, #2a2016 0%, #17120d 100%); color: #fff8ec; text-align: center; padding: 88px 0 72px; padding-bottom: calc(72px + env(safe-area-inset-bottom)); font-family: var(--lp-sans); }
.lp-final-cta .lp-mark { width: 32px; height: 32px; border: 1px solid var(--lp-gold); border-radius: 999px; display: grid; place-items: center; color: var(--lp-gold); font-family: var(--lp-serif); font-size: 22px; line-height: 1; background: rgba(255,255,255,.1); margin: 0 auto 16px; }
.lp-final-cta .lp-h2 { font-size: clamp(34px,4.2vw,62px); }
.lp-final-cta > .lp-wrap > p { color: rgba(255,248,236,.66); margin: 14px auto 0; max-width: 580px; font-size: clamp(15px,1.5vw,19px); line-height: 1.6; }
.lp-final-cta .lp-micro { color: rgba(255,248,236,.4); margin-top: 20px; }
...
@media (max-width: 768px) {
  :root { --lp-nav-h: 64px; }
  .lp-wrap { width: min(var(--lp-max), calc(100% - 32px)); }
  .lp-section { padding: 60px 0; }
  .lp-hero { min-height: calc(100svh - var(--lp-nav-h)); padding: 52px 0; align-items: flex-end; }
  .lp-hero h1 { font-size: clamp(40px,12.5vw,64px); letter-spacing: -.05em; margin: 20px 0 16px; }
  .lp-hero-pill { font-size: 10px; padding: 7px 13px; }
  .lp-hero-lead { font-size: clamp(15px,4.2vw,18px); }
  .lp-hero-actions { flex-direction: column; gap: 10px; }
  .lp-hero-actions .lp-btn { width: 100%; min-height: 56px; }
  .lp-hero-actions-center { align-items: center; }
  .lp-hero-actions-center .lp-btn { max-width: 380px; }
  .lp-section-head { grid-template-columns: 1fr; gap: 14px; }
  .lp-section-head .lp-copy { max-width: 100%; }
  .lp-grid-3 { grid-template-columns: 1fr; }
  .lp-story-section { padding: 60px 0; }
  .lp-story-grid { grid-template-columns: 1fr; gap: 32px; }
  .lp-story-lines { font-size: clamp(30px,10vw,48px); }
  .lp-rosary-section { grid-template-columns: 1fr; border-radius: 22px; padding: 24px; }
  .lp-forvous-grid { grid-template-columns: 1fr; max-width: 520px; }
  .lp-trust-grid { grid-template-columns: repeat(2,1fr); }
  .lp-step { grid-template-columns: 56px 1fr; gap: 14px; }
  .lp-step-num { font-size: 32px; }
  .lp-mission-card { padding: 52px 20px; border-radius: 28px; }
...
@media (max-width: 480px) {
  .lp-hero h1 { font-size: clamp(36px,12vw,52px); }
  .lp-enc-meta { grid-template-columns: 1fr; gap: 6px; }
  .lp-prayer-mode { grid-template-columns: 1fr; }
  .lp-trust-grid { grid-template-columns: 1fr; }
  .lp-step { grid-template-columns: 1fr; gap: 6px; }
  .lp-step-num { font-size: 26px; }
  .lp-forvous-item { padding: 18px 20px; }
  .lp-story-lines { font-size: clamp(28px,9.5vw,42px); }
  .lp-chrysostome { border-radius: 0 14px 14px 0; padding: 16px 18px; }
}
