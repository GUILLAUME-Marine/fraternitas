        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            {[["#comprendre", "La communauté"], ["#comment", "Comment ça marche"], ["#faq", "FAQ"]].map(([href, label]) => (
              <a key={href} href={href} className="text-sm font-medium transition-opacity hover:opacity-60"
                style={{ color: "rgba(17,16,9,0.6)" }}>{label}</a>
            ))}
          </div>

          <div className="hidden md:flex items-center gap-3">
            <Link href="/auth/login" className="text-sm font-medium px-4 py-2 rounded-full hover:bg-black/5 transition-all"
              style={{ color: "#111009" }}>Se connecter</Link>
            <Link href="/auth/register" className="text-sm font-semibold px-5 py-2.5 rounded-full hover:opacity-90 transition-all"
          ...
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }}
            ...
            <div className="px-6 py-5 flex flex-col gap-4">
              ...
              <div className="pt-3 border-t flex flex-col gap-3" style={{ borderColor: "rgba(17,16,9,0.08)" }}>
                <Link href="/auth/login" className="text-center py-3 rounded-xl font-medium text-sm"
                  style={{ border: "1.5px solid rgba(17,16,9,0.15)", color: "#111009" }}
                  onClick={() => setMenuOpen(false)}>Se connecter</Link>
                <Link href="/auth/register" className="text-center py-3 rounded-xl font-semibold text-sm"
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <motion.p
          ...
          style={{
            fontSize: "clamp(16px,2.2vw,19px)", color: "rgba(247,243,236,0.55)",
            fontWeight: 300, lineHeight: 1.65, maxWidth: "500px", margin: "0 auto 2.5rem",
          }}
        >
      ...
      >
        <span className="text-xs tracking-widest uppercase" style={{ color: "rgba(247,243,236,0.18)" }}>
          Découvrir
        </span>
        <div className="w-px h-7 animate-pulse"
          style={{ background: "linear-gradient(to bottom,rgba(196,154,60,0.4),transparent)" }} />
      </motion.div>
    </section>
  );
}
          ...
          <div className="rounded-3xl overflow-hidden grid md:grid-cols-2"
            ...
            <div className="p-10 md:p-14 flex flex-col justify-center">
              ...
              <p className="font-light leading-relaxed mb-4 text-sm" style={{ color: "rgba(17,16,9,0.62)" }}>
                ...
                structuré autour de{" "}
                <strong style={{ color: "#111009", fontWeight: 500 }}>cercles de proximité</strong>{" "}
              ...
              <p className="font-light leading-relaxed text-sm" style={{ color: "rgba(17,16,9,0.62)" }}>
                ...
                dans de vrais lieux. Fraternitas est ouvert à tous ceux qui se reconnaissent
              ...
              {[
                ...
                <div key={i} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-light text-sm leading-relaxed" style={{ color: "rgba(17,16,9,0.55)" }}>
                      {item.desc}
                    </p>
                  </div>
                </div>
            ...
            <Reveal key={i} delay={i * 75}>
              <div className="rounded-2xl p-7 h-full flex flex-col gap-4 transition-all hover:-translate-y-0.5 hover:shadow-sm"
                ...
                <p className="font-light leading-relaxed"
                  style={{ color: "rgba(17,16,9,0.68)", fontSize: "15px", lineHeight: 1.7 }}>
                  {item.text}
                </p>
              </div>
            </Reveal>
...
// ─── MANIFESTE — Matthieu 18,20 ───────────────────────────────────────────────
function ManifestoSection() {
  return (
    <section className="relative overflow-hidden" style={{ background: "#0D0C08" }}>
      <div className="absolute inset-0 pointer-events-none" style={{
        background: "radial-gradient(ellipse 70% 60% at 50% 50%,rgba(196,154,60,0.07) 0%,transparent 70%)",
      }} />

      <div className="w-full h-px"
        style={{ background: "linear-gradient(to right,transparent,rgba(196,154,60,0.2),transparent)" }} />

      <div className="relative z-10 max-w-3xl mx-auto px-6 py-28 md:py-36 text-center">

        <Reveal>
          <div className="inline-flex items-center gap-3 mb-12">
            <div className="h-px w-12" style={{ background: "rgba(196,154,60,0.3)" }} />
            <span className="text-xs font-medium tracking-widest uppercase"
        ...
        <Reveal delay={80}>
          <blockquote className="mb-10">
            <p style={{
              ...
              color: "#F7F3EC", lineHeight: 1.25, letterSpacing: "-0.01em",
              marginBottom: "1.25rem",
            }}>
              « Là où deux ou trois sont réunis
              <br className="hidden sm:block" />
              en mon nom,
              <em style={{ color: "#C49A3C" }}> je suis au milieu d&rsquo;eux. »</em>
            </p>
            <footer style={{
              fontSize: "15px", fontWeight: 300,
              color: "rgba(247,243,236,0.35)", letterSpacing: "0.02em",
            }}>
              — Matthieu 18, 20
            </footer>
          </blockquote>
        ...
        <Reveal delay={160}>
          <div className="flex items-center justify-center gap-4 mb-10">
            <div className="h-px w-16" style={{ background: "rgba(196,154,60,0.15)" }} />
            <span style={{ color: "rgba(196,154,60,0.35)", fontSize: "12px" }}>✦</span>
            <div className="h-px w-16" style={{ background: "rgba(196,154,60,0.15)" }} />
          </div>
        </Reveal>
        ...
        <Reveal delay={220}>
          <p style={{
            fontSize: "clamp(16px,2vw,19px)", fontWeight: 300,
            color: "rgba(247,243,236,0.52)", lineHeight: 1.8,
          ...
          <p style={{
            ...
            <strong style={{ color: "rgba(247,243,236,0.75)", fontWeight: 400 }}>
...
// ─── Section "Aller à la messe ensemble" ──────────────────────────────────────
          ...
          <div>
            <Reveal>
              ...
              <h2 style={{
                ...
                color: "#111009", lineHeight: 1.18, marginBottom: "1.25rem",
              }}>
                Aller à la messe,
                <br /><em className="italic" style={{ color: "#C49A3C" }}>ensemble.</em>
              </h2>
              <p className="font-light text-sm leading-relaxed mb-5" style={{ color: "rgba(17,16,9,0.6)" }}>
                Beaucoup n&rsquo;y vont plus — non par manque de foi, mais par solitude.
                Par peur d&rsquo;y aller seul. Par difficulté à comprendre ce qui se passe.
                Par manque d&rsquo;un visage familier dans l&rsquo;assemblée.
              </p>
              <p className="font-light text-sm leading-relaxed mb-6" style={{ color: "rgba(17,16,9,0.6)" }}>
                Sur Fraternitas, vous pouvez annoncer :{" "}
                <em style={{ color: "#111009" }}>
                  «&thinsp;Je vais à la messe dimanche à Saint-Eustache à 10h — qui vient ?&thinsp;»
                </em>
                <br /><br />
                Un membre de votre cercle répond. Vous vous retrouvez à l&rsquo;entrée.
              ...
              <div className="p-4 rounded-2xl mb-8"
                ...
                <p className="text-sm font-light leading-relaxed" style={{ color: "rgba(17,16,9,0.65)" }}>
                  <strong style={{ color: "#111009", fontWeight: 500 }}>Important :</strong>{" "}
                  La messe n&rsquo;est pas un lieu de rencontre sociale. C&rsquo;est une rencontre
                  avec le Christ. Fraternitas facilite la présence ensemble — chacun prie selon
                  son cœur, en silence et en liberté.
                </p>
              </div>
          ...
          <Reveal delay={100}>
            <div className="space-y-3">
              <div className="rounded-2xl p-5"
                style={{ background: "#FFFFFF", border: "1.5px solid rgba(17,16,9,0.08)", boxShadow: "0 4px 24px rgba(17,16,9,0.06)" }}>
                <div className="flex items-start gap-3 mb-4">
                  <div className="w-9 h-9 rounded-full flex items-center justify-center shrink-0 font-medium text-sm"
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      <span className="text-xs" style={{ color: "rgba(17,16,9,0.35)" }}>Paris 4e</span>
                    </div>
                    <p className="text-xs" style={{ color: "rgba(17,16,9,0.4)" }}>Il y a 2 heures</p>
                  </div>
                </div>
                <div className="rounded-xl p-4 mb-4" style={{ background: "#F7F3EC" }}>
                  <div className="flex items-center gap-2 mb-2">
                    <span style={{ color: "#C49A3C", fontSize: "13px" }}>⛪</span>
                    <p className="text-xs font-medium tracking-wide uppercase"
                      style={{ color: "rgba(17,16,9,0.4)" }}>Intention de messe</p>
                  </div>
                  <p className="text-sm font-medium mb-1" style={{ color: "#111009" }}>
                    Messe dominicale — Saint-Eustache, Paris
                  </p>
                  <p className="text-xs font-light" style={{ color: "rgba(17,16,9,0.55)" }}>
                    Dimanche 10 mai · 10h30 · Qui veut venir ? Je suis un peu perdue dans la liturgie
                    des messes chantées 🙏
                  </p>
                </div>
                <div className="flex items-center gap-2 flex-wrap">
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium"
                    style={{ background: "rgba(196,154,60,0.1)", border: "1px solid rgba(196,154,60,0.2)", color: "#8A6A20" }}>
                    🙏 Je prie pour cette intention
                  </div>
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium"
                    style={{ border: "1.5px solid rgba(17,16,9,0.1)", color: "rgba(17,16,9,0.6)" }}>
                    Je vous accompagne
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-2xl p-4 ml-4"
                style={{ background: "#FFFFFF", border: "1.5px solid rgba(17,16,9,0.06)" }}>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 font-medium text-xs"
                    style={{ background: "linear-gradient(135deg,#C5D4A0,#6CA469)", color: "#1B3A1B" }}>P</div>
                  <div>
                    <p className="text-sm font-medium mb-0.5" style={{ color: "#111009" }}>Pierre</p>
                    <p className="text-sm font-light" style={{ color: "rgba(17,16,9,0.65)" }}>
              ...
              <p className="text-xs text-center font-light pt-1" style={{ color: "rgba(17,16,9,0.28)" }}>
        ...
        <Reveal>
          <div className="mb-14">
            <p className="text-xs font-medium tracking-widest uppercase mb-4"
              style={{ color: "rgba(17,16,9,0.35)" }}>Comment ça marche</p>
            <h2 style={{
              fontFamily: "'Cormorant Garamond',Georgia,serif",
...
// ─── "Pour vous si" — avec citation Jean Chrysostome ─────────────────────────
function ForWhoSection() {
  const items = [
    ...
    "Vous aimeriez aller à la messe mais vous sentez seul ou perdu dans la liturgie",
  ...
  return (
    <section className="py-24 px-6" style={{ background: "#F7F3EC" }}>
      <div className="max-w-5xl mx-auto">
        ...
        {/* Citation Jean Chrysostome — placée en tête de section, pleine largeur */}
        <Reveal>
          <div className="mb-16 rounded-2xl px-8 py-10 md:px-14 md:py-12 relative overflow-hidden"
            style={{ background: "#EDE6D8", border: "1.5px solid rgba(196,154,60,0.2)" }}>
            ...
            <div style={{
              ...
              color: "rgba(196,154,60,0.10)", fontWeight: 300,
            ...
            <div className="relative z-10 text-center max-w-2xl mx-auto">
              ...
              <p style={{
                ...
                color: "rgba(17,16,9,0.45)", letterSpacing: "0.02em",
              }}>
                — Saint Jean Chrysostome, archevêque de Constantinople (IVe siècle)
              </p>

              {/* Ligne de séparation */}
              <div className="mt-7 mb-5 flex items-center justify-center gap-4">
                <div className="h-px w-12" style={{ background: "rgba(17,16,9,0.12)" }} />
                <span style={{ color: "rgba(196,154,60,0.45)", fontSize: "11px" }}>✦</span>
                <div className="h-px w-12" style={{ background: "rgba(17,16,9,0.12)" }} />
              </div>

              <p style={{
                fontSize: "15px", fontWeight: 300,
                color: "rgba(17,16,9,0.58)", lineHeight: 1.7,
              }}>
                Vivre sa foi sans communauté, c&rsquo;est s&rsquo;exposer au doute, à l&rsquo;isolement,
                et finalement à l&rsquo;abandon. L&rsquo;Église n&rsquo;est pas une option — elle est
                la maison du chrétien. Fraternitas vous aide à la trouver, près de chez vous.
              </p>
            </div>
          </div>
        </Reveal>
            ...
            {items.map((item, i) => (
              <Reveal key={i} delay={i * 55}>
                <div className="flex items-start gap-3">
                  ...
                  <p className="font-light text-sm leading-relaxed" style={{ color: "rgba(17,16,9,0.65)" }}>
                    {item}
                  </p>
                </div>
              </Reveal>
...
const FAQ_ITEMS = [
  {
    ...
    a: "Non. Fraternitas accueille tous ceux qui se reconnaissent dans la foi catholique, qu'ils soient pratiquants réguliers, en chemin, ou simplement en quête de sens. Aucun jugement, aucune condition d'entrée.",
  },
  {
    q: "Y a-t-il une limite d'âge ?",
    a: "Aucune. Fraternitas est ouvert à tous, quel que soit l'âge. Votre place est ici si vous cherchez une communauté.",
  },
  {
    q: "Est-ce que c'est gratuit ?",
    a: "L'accès de base est gratuit : profil, cercles, événements, vie spirituelle quotidienne. Un abonnement premium sera proposé pour des fonctionnalités avancées — mais le cœur du produit restera toujours accessible.",
  },
  {
  ...
  {
    q: "La fonctionnalité 'aller à la messe ensemble' ne risque-t-elle pas de perturber le temps de prière ?",
    a: "Non, car tout se passe avant et après la messe. Vous vous retrouvez à l'entrée, vous priez séparément selon votre cœur. La messe reste un temps de rencontre avec le Christ — Fraternitas facilite simplement la présence humaine autour de ce moment sacré.",
  },
  {
    q: "Fraternitas est-il affilié à un mouvement ou un diocèse ?",
    a: "Non. Fraternitas est une plateforme indépendante, ouverte à toutes les sensibilités catholiques — charismatique, traditionnelle, dominicaine, ignatienne ou autre.",
  },
  {
    q: "Mes données personnelles sont-elles protégées ?",
    a: "Oui. Vos données ne sont jamais vendues ni partagées avec des tiers. Vous contrôlez votre visibilité. La confiance est au cœur de Fraternitas.",
  },
];
      ...
      <div className="max-w-2xl mx-auto">
        <Reveal>
          <div className="text-center mb-12">
            <p className="text-xs font-medium tracking-widest uppercase mb-4"
              style={{ color: "rgba(17,16,9,0.35)" }}>Questions fréquentes</p>
            <h2 style={{
              fontFamily: "'Cormorant Garamond',Georgia,serif",
              fontSize: "clamp(26px,4vw,40px)", fontWeight: 400, color: "#111009",
            }}>
              ...
              <div className="rounded-xl overflow-hidden"
                ...
                <button
                  ...
                  <span className="font-medium text-sm leading-relaxed flex-1"
                    style={{ color: "#111009" }}>{item.q}</span>
                  <span className="shrink-0 text-xl leading-none transition-transform"
                    style={{ color: "#C49A3C", transform: open === i ? "rotate(45deg)" : "none" }}>+</span>
                </button>
                <AnimatePresence>
                  {open === i && (
                    <motion.div
                      ...
                      <p className="px-5 pb-5 font-light text-sm leading-relaxed"
                        style={{ color: "rgba(17,16,9,0.58)" }}>{item.a}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
  ...
  return (
    <section className="py-28 px-6 relative overflow-hidden" style={{ background: "#111009" }}>
      ...
      <div className="relative z-10 max-w-xl mx-auto text-center">
        ...
        <Reveal delay={130}>
          <p className="mb-9 font-light leading-relaxed"
...
function Footer() {
  return (
    <footer className="py-10 px-6"
      style={{ background: "#111009", borderTop: "1px solid rgba(247,243,236,0.06)" }}>
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="flex items-center gap-2.5">
          ...
          <span style={{
            fontFamily: "'Cormorant Garamond',Georgia,serif",
            fontSize: "16px", color: "rgba(247,243,236,0.6)",
          }}>Fraternitas</span>
        </div>
        ...
        <p className="text-xs font-light" style={{ color: "rgba(247,243,236,0.18)" }}>
