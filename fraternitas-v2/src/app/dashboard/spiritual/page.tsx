...
export default function PrionsPage() {
  ...
  // Lire le hash pour restaurer l'onglet (retour depuis parcours, prière individuelle…)
  useEffect(() => {
    const readHash = () => {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: C.sans }}>
      ...
      {/* ══ HEADER — fond OR, onglets bien visibles ══ */}
      <header style={{
      ...
      <main style={{ maxWidth: "600px", margin: "0 auto", padding: "14px 14px 60px" }}>
        ...
        {tab === "jour" && (
          <div className="fu" style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            {/* ── Bandeau date + semaine liturgique ── */}
            <div style={{
              ...
              <span style={{ fontFamily: C.serif, fontSize: "15px", fontWeight: 300, color: "#F5EFE4" }}>
                {dateLabel}
              </span>
            ...
            {/* ── Citation du jour — EN PREMIER, avant l'évangile ── */}
            {loading ? (
              ...
              <div style={{ background: "#111009", borderRadius: "14px", padding: "16px 18px", position: "relative", overflow: "hidden" }}>
                ...
                <p style={{ fontSize: "11px", fontWeight: 500, color: "rgba(196,154,60,0.75)", position: "relative", zIndex: 1, fontFamily: C.sans }}>
                  — {data.quote.author}
                </p>
              </div>
            ) : null}
            ...
            <div style={{ background: C.card, borderRadius: "14px", border: `1.5px solid ${C.cardBorder}`, overflow: "hidden" }}>
              {loading ? (
                ...
                <div style={{ padding: "14px 16px" }}>
                  {/* Nom évangéliste + référence — sans gospel.title (redondant) */}
                  ...
                  {/* Texte — compact, lineHeight 1.52 */}
                  <p style={{ fontFamily: C.serif, fontSize: "15px", fontWeight: 300, fontStyle: "italic", color: C.ink80, lineHeight: 1.52, whiteSpace: "pre-line", margin: 0 }}>
                    {previewLines}
                  </p>
            ...
            <div style={{ height: "4px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <div style={{ width: "20px", height: "1px", background: C.gold, opacity: 0.3 }} />
            </div>

            {/* ── Saint du jour ── */}
            {loading ? (
              <div style={{ background: C.cream, borderRadius: "14px", padding: "12px 14px", border: `1.5px solid ${C.goldBorder}`, display: "flex", flexDirection: "column", gap: "7px" }}>
                <Skel w="50%" h="16px" /><Skel w="25%" h="10px" /><Skel w="90%" h="12px" />
              </div>
            ) : data?.saint ? (
              <div style={{ background: C.cream, borderRadius: "14px", padding: "12px 14px", border: `1.5px solid ${C.goldBorder}` }}>
        ...
        {tab === "chapelet" && (
          <div className="fu" style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            {/* Reprendre OU Commencer — jamais les deux */}
            {rosary ? (
              <div style={{ background: C.card, borderRadius: "14px", padding: "14px", border: "1.5px solid rgba(196,154,60,0.35)" }}>
                ...
                {/* Reprendre → directement en prière via ?resume=1 */}
        ...
        {tab === "prieres" && (
          <div className="fu" style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            <p style={{ fontFamily: C.serif, fontSize: "22px", fontWeight: 300, color: C.ink, marginBottom: "6px" }}>Prières</p>
            ...
            <div onClick={() => router.push("/dashboard/spiritual/parcours")} style={{ background: "linear-gradient(135deg,#1A1410 0%,#2C1E08 100%)", borderRadius: "16px", border: "1.5px solid rgba(196,154,60,0.30)", padding: "16px", cursor: "pointer", marginBottom: "4px" }}>
              ...
              <p style={{ fontSize: "12px", fontWeight: 300, color: "rgba(245,239,228,0.50)", fontFamily: C.sans, marginBottom: "10px", lineHeight: 1.5 }}>Un parcours guidé · 5 minutes.</p>
