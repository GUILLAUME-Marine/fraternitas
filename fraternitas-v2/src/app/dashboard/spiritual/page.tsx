...
export default function PrionsPage() {
  ...
  const gospelParagraphs = gospelText.split("\n\n").filter(Boolean);
  const gospelPreview = gospelParagraphs[0] || "";
  const gospelRest = gospelParagraphs.slice(1).join("\n\n");
    ...
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: C.sans }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .btn-sound-active { background: #1A1410 !important; border-color: #1A1410 !important; color: #C49A3C !important; }
      `}</style>
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 16px 8px" }}>
          ...
          {/* Droite — semaine liturgique EN GRAS */}
      ...
      <main style={{ maxWidth: "600px", margin: "0 auto", padding: "16px 14px 80px" }}>
          ...
          <div className="fu" style={{ display: "flex", flexDirection: "column", gap: "0" }}>
              ...
              <div style={{ background: C.card, borderRadius: "16px", border: `1.5px solid ${C.cardBorder}`, overflow: "hidden" }}>
                {loading ? (
                  <div style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "9px" }}>
                    <Skel w="60%" h="10px" /><Skel w="90%" h="18px" /><Skel w="75%" h="14px" /><Skel w="40%" h="10px" />
                  </div>
                ) : data?.gospel ? (
                  <div style={{ padding: "16px" }}>
                    {data.gospel.title && (
                      <p style={{ fontFamily: C.serif, fontSize: "15px", fontWeight: 400, fontStyle: "italic", color: C.ink65, marginBottom: "10px", lineHeight: 1.4 }}>
                        « {stripHtml(data.gospel.title)} »
                      </p>
                    )}
                    <p style={{ fontFamily: C.serif, fontSize: "18px", fontWeight: 300, fontStyle: "italic", color: C.ink80, lineHeight: 1.65, marginBottom: gospelRest ? "10px" : "14px" }}>
                      {gospelPreview}
                    </p>

                    {/* Suite évangile — accordéon propre */}
                    {gospelRest && gospelOpen && (
                      <p style={{ fontFamily: C.serif, fontSize: "17px", fontWeight: 300, color: "rgba(17,16,9,0.76)", lineHeight: 1.86, whiteSpace: "pre-line", paddingTop: "12px", marginBottom: "12px", borderTop: `1px solid ${C.ink12}` }}>
                        {gospelRest}
                      </p>
                    )}

                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: "12px", borderTop: `1px solid ${C.ink12}` }}>
            ...
            <div style={{ marginBottom: "6px" }}>
              ...
              {loading ? (
                <div style={{ background: C.cream, borderRadius: "16px", padding: "14px 16px", border: `1.5px solid ${C.goldBorder}`, display: "flex", flexDirection: "column", gap: "8px" }}>
                  <Skel w="50%" h="18px" /><Skel w="25%" h="10px" /><Skel w="90%" h="12px" /><Skel w="75%" h="12px" />
                </div>
              ) : data?.saint ? (
                <div style={{ background: C.cream, borderRadius: "16px", padding: "14px 16px", border: `1.5px solid ${C.goldBorder}` }}>
                  <p style={{ fontFamily: C.serif, fontSize: "20px", fontWeight: 400, color: C.ink, marginBottom: "3px", lineHeight: 1.2 }}>
                    {data.saint.name}
                  </p>
                  {data.saint.dates && (
                  ...
                  <p style={{ fontFamily: C.serif, fontSize: "15px", fontWeight: 300, color: C.ink65, lineHeight: 1.7, margin: 0 }}>
            ...
            <div>
              ...
              {loading ? (
                ...
                <div style={{ background: "#111009", borderRadius: "16px", padding: "18px 18px", position: "relative", overflow: "hidden" }}>
                  <div style={{ position: "absolute", top: "8px", left: "16px", fontFamily: C.serif, fontSize: "64px", lineHeight: 1, color: "rgba(184,137,58,0.12)", pointerEvents: "none", userSelect: "none" }}>«</div>
                  <p style={{ fontFamily: C.serif, fontSize: "19px", fontWeight: 300, fontStyle: "italic", color: "#F5EFE4", lineHeight: 1.65, marginBottom: "12px", position: "relative", zIndex: 1 }}>
                    « {data.quote.text} »
                  </p>
        ...
        {tab === "chapelet" && (
          <div className="fu" style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            {/* Carte mystère — fond sombre chaud */}
            <div style={{
              ...
              <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", pointerEvents: "none" }}>
                <svg width="260" height="260" viewBox="0 0 260 260" fill="none">
                  <circle cx="130" cy="130" r="118" stroke="#C49A3C" strokeWidth="0.5" opacity="0.12"/>
                  <circle cx="130" cy="130" r="90" stroke="#C49A3C" strokeWidth="0.5" opacity="0.09"/>
                  <circle cx="130" cy="130" r="62" stroke="#C49A3C" strokeWidth="0.4" opacity="0.06"/>
                  <circle cx="130" cy="130" r="38" stroke="#C49A3C" strokeWidth="0.4" opacity="0.05"/>
                </svg>
              </div>
              <div style={{ position: "relative", zIndex: 1 }}>
                ...
                <p style={{ fontFamily: C.serif, fontSize: "24px", fontWeight: 300, color: "#F5EFE4", lineHeight: 1.15, marginBottom: "6px" }}>
                  {rosary ? MYSTERY_LABELS[rosary.mysteryType] : "Mystères Douloureux"}
                </p>
                <p style={{ fontFamily: C.serif, fontSize: "14px", fontWeight: 300, fontStyle: "italic", color: "rgba(245,239,228,0.45)", lineHeight: 1.5, margin: 0 }}>
            ...
            {/* Intention */}
            <div style={{ background: "#FAF5EC", borderRadius: "14px", border: "1.5px solid rgba(196,154,60,0.28)", padding: "14px 16px" }}>
              <p style={{ fontSize: "10px", fontWeight: 500, letterSpacing: "0.08em", textTransform: "uppercase", color: "#B8973A", fontFamily: C.sans, marginBottom: "8px" }}>
                Confier ce chapelet
              </p>
              <input
                type="text"
                placeholder="Pour mon père… Pour la paix…"
                style={{
                  width: "100%", padding: "10px 13px",
                  border: "1.5px solid rgba(196,154,60,0.28)",
                  borderRadius: "10px", background: "rgba(255,255,255,0.70)",
                  color: C.ink, fontFamily: C.serif, fontSize: "17px",
                  fontWeight: 300, fontStyle: "italic", outline: "none",
                }}
              />
            </div>

            {/* Ambiance sonore — barre compacte sans émojis */}
            <div style={{
              background: C.card, borderRadius: "10px",
              border: `1px solid ${C.cardBorder}`,
              padding: "7px 12px", display: "flex", alignItems: "center", gap: "8px",
            }}>
              <span style={{ fontSize: "10px", fontWeight: 500, letterSpacing: "0.08em", textTransform: "uppercase", color: C.ink35, fontFamily: C.sans, flexShrink: 0 }}>
                Son
              </span>
              <div style={{ display: "flex", gap: "5px", flex: 1 }}>
                {["Silence", "Plain-chant", "Chant marial"].map((label, i) => (
                  <div key={i} style={{
                    ...
                    border: `1px solid ${i === 0 ? "#1A1410" : C.cardBorder}`,
                    background: i === 0 ? "#1A1410" : "transparent",
                    fontSize: "11px", fontWeight: i === 0 ? 500 : 400,
                    color: i === 0 ? "#C49A3C" : C.ink50,
            ...
            {rosary && (
              <div style={{ background: C.card, borderRadius: "12px", padding: "12px 14px", border: "1.5px solid rgba(196,154,60,0.32)" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "8px" }}>
                  <div>
                    <p style={{ fontSize: "13px", fontWeight: 500, color: C.ink, margin: "0 0 2px" }}>
                      {MYSTERY_LABELS[rosary.mysteryType]}
                    </p>
                    <p style={{ fontSize: "11px", fontWeight: 300, color: C.ink50, margin: 0 }}>
                      Dizaine {rosary.decadeIndex + 1} · {rosaryPercent}%
                    </p>
                  </div>
                  <span style={{ fontSize: "22px", fontWeight: 300, color: "#C49A3C", fontFamily: C.serif }}>
                    {rosaryPercent}%
                  </span>
                </div>
                <div style={{ display: "flex", gap: "4px", marginBottom: "8px" }}>
                  {Array.from({ length: 5 }, (_, i) => (
                    <div key={i} style={{
                      ...
                      background: i < rosary.decadeIndex ? "#1A1410" : i === rosary.decadeIndex ? "#C49A3C" : C.ink12,
                      opacity: i <= rosary.decadeIndex ? 0.7 : 1,
                    }} />
                  ))}
                </div>
                <div style={{ display: "flex", gap: "7px" }}>
                  <Link href="/dashboard/spiritual/chapelet" style={{ flex: 2, textDecoration: "none" }}>
                  ...
                  <button style={{ flex: 1, padding: "9px", borderRadius: "10px", border: `1.5px solid ${C.ink12}`, background: "none", fontSize: "12px", color: C.ink50, cursor: "pointer", fontFamily: C.sans }}>
                    Recommencer
                  </button>
                </div>
              </div>
            ...
            {/* Bouton commencer — doré */}
            <Link href="/dashboard/spiritual/chapelet" style={{ textDecoration: "none" }}>
              <button style={{
                width: "100%", padding: "15px",
                background: "#C49A3C", border: "none", borderRadius: "14px",
                color: "#1A1410", fontSize: "14px", fontWeight: 500,
            ...
            <div style={{ background: C.card, borderRadius: "13px", border: `1.5px solid ${C.cardBorder}`, padding: "14px 16px" }}>
              <p style={{ fontSize: "10px", fontWeight: 500, letterSpacing: "0.10em", textTransform: "uppercase", color: "#B8973A", fontFamily: C.sans, marginBottom: "6px" }}>
                Le saviez-vous ?
              </p>
              <p style={{ fontFamily: C.serif, fontSize: "16px", fontWeight: 300, fontStyle: "italic", color: C.ink, lineHeight: 1.55, marginBottom: "4px" }}>
                « Le chapelet est l&apos;arme de notre temps. »
              </p>
              <p style={{ fontSize: "11px", fontWeight: 400, color: C.ink50, fontFamily: C.sans, marginBottom: "10px" }}>
                — Saint Jean-Paul II
              </p>
              <Link href="/dashboard/spiritual/chapelet" style={{ fontSize: "12px", fontWeight: 500, color: "#B8973A", textDecoration: "none", display: "flex", alignItems: "center", gap: "3px", fontFamily: C.sans }}>
        ...
        {tab === "prieres" && (
          <div className="fu" style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            <div style={{ marginBottom: "8px" }}>
              ...
              <p style={{ fontFamily: C.serif, fontSize: "14px", fontWeight: 300, fontStyle: "italic", color: C.ink50, lineHeight: 1.6, marginBottom: "16px" }}>
                Parce qu&apos;il y a toujours des mots pour s&apos;adresser à Dieu,
                même quand on ne les connaît pas encore.
              </p>
            </div>

            {/* Card "Commencer à prier" — parcours guidé */}
            <div
              onClick={() => router.push("/dashboard/spiritual/parcours")}
              style={{
                background: "linear-gradient(135deg,#1A1410 0%,#2C1E08 100%)",
                borderRadius: "16px", border: "1.5px solid rgba(196,154,60,0.30)",
                padding: "20px 18px 18px", marginBottom: "0px", cursor: "pointer",
              }}
            >
              <p style={{ fontSize: "9px", fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(196,154,60,0.60)", fontFamily: C.sans, marginBottom: "7px" }}>
                Nouveau ici ?
              </p>
              <p style={{ fontFamily: C.serif, fontSize: "22px", fontWeight: 300, color: "#F5EFE4", marginBottom: "5px", lineHeight: 1.25 }}>
                Commencer à prier.
              </p>
              <p style={{ fontSize: "12px", fontWeight: 300, color: "rgba(245,239,228,0.50)", fontFamily: C.sans, marginBottom: "14px", lineHeight: 1.55 }}>
                Un parcours guidé selon ton niveau · Débutant ou pratiquant.
              </p>
              <span style={{
                display: "inline-flex", alignItems: "center",
                background: "#C49A3C", border: "none", borderRadius: "99px",
                padding: "8px 18px", fontSize: "12px", fontWeight: 500,
                color: "#1A1410", fontFamily: C.sans,
              }}>
                Je commence →
              </span>
            </div>
            ...
            {PRAYER_CATEGORIES.map(cat => (
              <div key={cat.id} style={{ background: C.card, borderRadius: "16px", border: `1.5px solid ${C.cardBorder}`, overflow: "hidden" }}>
                <button
                        ...
                        <Link key={prayer.slug + i} href={href} style={{ textDecoration: "none", display: "block" }}>
                          <div className="row-hover" style={{
                            ...
                            <div>
                              ...
                              <p style={{ fontSize: "11px", fontWeight: 300, color: C.ink50, margin: 0 }}>{prayer.sub}</p>
                            </div>
                            <Chev />
                          </div>
                        </Link>
